...
const Footer = () => {
    return (
        <div className="bg-[#FFF0F0] pt-32 pb-10 ">
            <div className=" w-4/5 mx-auto text-[#342E5C]  flex justify-between flex-col lg:flex-row">
                {/* 1st div-------------------------------------------->*/}
                ...
                {/* 2nd div -------------------------------------------> */}
                <div className="space-y-10 lg:space-y-20 my-20 lg:my-0 ">
                    <div className="">
